...
#define OPTIMAL_FAN_IN min((DRAM_SIZE / OPTIMAL_SSD_PAGE_SIZE), ((lluint)SSD_SIZE / OPTIMAL_HDD_PAGE_SIZE))
#define OPTIMAL_NUM_RUNS OPTIMAL_FAN_IN
#define MAX_SSD_NUM_RUNS ((lluint)SSD_SIZE / OPTIMAL_HDD_PAGE_SIZE)
#define MAX_DRAM_NUM_RUNS (DRAM_SIZE / OPTIMAL_SSD_PAGE_SIZE)
